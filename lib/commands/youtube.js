module.exports = function registerYouTubeCommands (client){
    ...
    if (message.content.toLowerCase() === '!dad-help') {
      ...
      collector.on('collect', async (msg) => {
        ...
        if (results) {
          ...
          // you can get the index from the second argument to .map
          // also think about how you might simplify this with a .reduce     
          const titles = items.map(result, i => {
